...
public class AllocationSchedulerEvaluationTestStep1 {

    // paths to the used model files.
    private String k8sSchedulerTestModelSystem = "testmodels/k8sSchedulerTestModelAllPodsAllocatedEvaluate/step1.system";
    ...
    private String k8sSchedulerTestModelAllocation = "testmodels/k8sSchedulerTestModelAllPodsAllocatedEvaluate/step1.allocation";
    ...
    public void testSchedule() {
        ...
        for (AssemblyContext assembly : result.get()
            ...
            assert (assembly.getId()
                .equals("_-uiy8LhjEeyjjf2HilH6cg"));
            assert (result.get()
                .get(assembly)
                .getId()
