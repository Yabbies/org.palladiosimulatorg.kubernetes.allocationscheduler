...
public class AllocationSchedulerEvaluationTestStep2 {
    // paths to the used model files.
    private String k8sSchedulerTestModelSystem = "testmodels/k8sSchedulerTestModelAllPodsAllocatedEvaluate/step2.system";
    ...
    private String k8sSchedulerTestModelAllocation = "testmodels/k8sSchedulerTestModelAllPodsAllocatedEvaluate/step2.allocation";
    ...
    public void testSchedule() {
        ...
        for (AssemblyContext assembly : result.get()
            ...
            assert (assembly.getId()
                .equals("_ckJGoM9CEey-UO5WQaTdrg"));
            assert (result.get()
                .get(assembly)
                .getId()
