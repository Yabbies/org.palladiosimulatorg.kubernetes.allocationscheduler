...
public class AllocationSchedulerEvaluationTestStep4 {
    // paths to the used model files.
    private String k8sSchedulerTestModelSystem = "testmodels/k8sSchedulerTestModelAllPodsAllocatedEvaluate/step4.system";
    ...
    private String k8sSchedulerTestModelAllocation = "testmodels/k8sSchedulerTestModelAllPodsAllocatedEvaluate/step4.allocation";
    ...
    public void testSchedule() {
        ...
        for (AssemblyContext assembly : result.get()
            ...
            assert (assembly.getId()
                .equals("_65kiEM9EEey-UO5WQaTdrg"));
            assert (result.get()
                .get(assembly)
                .getId()
